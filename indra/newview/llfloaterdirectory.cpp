...
void LLFloaterDirectory::paginate()
{
    if (mNumResultsReceived)
    {
        ...
        mResultsStatus->setText(getString((mNumResultsReceived > (S32)mCurrentQuery.results_per_page)
    ...
    childSetEnabled("PageUp", mNumResultsReceived > (S32)mCurrentQuery.results_per_page);
